...
import { FaChartLine, FaEye, FaPhone, FaWhatsapp, FaEnvelope, FaEdit, FaPlus } from 'react-icons/fa';
...
export default function Dashboard() {
  ...
  const [metricas, setMetricas] = useState({
    visitas: {
      periodo: '7', // dias
      dados: [
        { data: '2025-05-26', total_visitas: 5 },
        { data: '2025-05-27', total_visitas: 8 },
        { data: '2025-05-28', total_visitas: 12 },
        { data: '2025-05-29', total_visitas: 7 },
        { data: '2025-05-30', total_visitas: 10 },
    ...
    cliques: {
      periodo: '7', // dias
      dados: [
        { data: '2025-05-26', tipo_contato: 'whatsapp', total_cliques: 2 },
  ...
  const processarDadosCliques = () => {
    ...
    metricas.cliques.dados.forEach(item => {
      ...
      dadosProcessados[item.data][item.tipo_contato] = item.total_cliques;
    });
