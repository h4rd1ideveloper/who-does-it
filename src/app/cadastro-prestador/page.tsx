...
export default function CadastroPrestador() {
  ...
  const handleValidarToken: React.FormEventHandler<HTMLFormElement> = async (e) => {
    e.preventDefault();
    setLoading(true);
    setError('');
  ...
  const handleServicoChange: (index: number) => React.ChangeEventHandler<HTMLSelectElement> = (index) => (e) => {
    ...
    setFormData({
      ...formData, servicos: updatedServicos,
    });
  };

  const addServico = () => {
    setFormData({
      ...formData, servicos: [...formData.servicos, {
        categoria_id: '',
        titulo: '',
        descricao: '',
        preco_min: '',
  ...
  return (<main>
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <div className="p-6">
          {!tokenValidado ? (// Etapa de validação de token
            <div>
            ...
            </div>) : success ? (// Mensagem de sucesso
            ...
            </div>) : (// Formulário de cadastro em etapas
            <div>
              {/* Indicador de progresso */}
              <div className="flex mb-8">
                <div className={`flex-1 text-center ${step >= 1 ? 'text-blue-600' : 'text-gray-400'}`}>
                  <div
                    className={`w-10 h-10 mx-auto rounded-full flex items-center justify-center ${step >= 1 ? 'bg-blue-100 border-2 border-blue-600' : 'bg-gray-200'}`}>
                    1
                  </div>
                ...
                <div className={`flex-1 text-center ${step >= 2 ? 'text-blue-600' : 'text-gray-400'}`}>
                  <div
                    className={`w-10 h-10 mx-auto rounded-full flex items-center justify-center ${step >= 2 ? 'bg-blue-100 border-2 border-blue-600' : 'bg-gray-200'}`}>
                    2
                  </div>
                ...
                <div className={`flex-1 text-center ${step >= 3 ? 'text-blue-600' : 'text-gray-400'}`}>
                  <div
                    className={`w-10 h-10 mx-auto rounded-full flex items-center justify-center ${step >= 3 ? 'bg-blue-100 border-2 border-blue-600' : 'bg-gray-200'}`}>
                    3
                  </div>
                  ...
                  {formData.servicos.map((servico, index) => (
                    <div key={index} className="mb-6 p-4 border border-gray-200 rounded-lg">
                      <div className="flex justify-between items-center mb-4">
                        ...
                        {formData.servicos.length > 1 && (<button
                          type="button"
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                          <label className="block text-gray-700 text-sm font-bold mb-2"
                                 htmlFor={`local_atendimento_${index}`}>
